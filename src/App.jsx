...
import { ModalProvider } from "./pages/HomeDoador/components/hooks/useModal";
                ...
                <Suspense fallback={<Loading />}>
                  ...
                  <div className="flex-grow">
                    <Routes>
                      ...
                      <Route
                        path="/instituicao/"
                        element={<HomeInstituicao />}
                      />
                      <Route
                        path="/instituicao/estoque/estoque"
                        element={<Estoque />}
                      />
                      <Route
                        path="/instituicao/estoque/criar_doacao"
                        element={<TelaDoacao />}
                      />
                      <Route
                        path="/instituicao/assistidos/assistidos"
                        element={<Assistidos />}
                      />
                      <Route
                        path="/instituicao/assistidos/lista_espera"
                        element={<ListaEspera />}
                      />
                    </Routes>
                  </div>
